...
const getSampleTheme = variables => ({
	'NativeBase.ViewNB': {
		'.backgroundPrimary': {
...
export default variableOverrides => merge(getTheme({ ...variableDefaults, ...variableOverrides }), getSampleTheme({ ...variableDefaults, ...variableOverrides }));
